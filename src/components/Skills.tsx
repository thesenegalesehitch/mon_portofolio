        ...
        <div className="mt-12 bg-white rounded-2xl p-8 shadow-lg">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {[
              ...
              <span
                key={index}
                className="px-6 py-3 bg-gradient-to-r from-emerald-50 to-teal-50 text-emerald-700 rounded-full font-medium hover:shadow-md transition-all duration-300 hover:scale-105"
              >
                {skill}
              </span>
            ))}
